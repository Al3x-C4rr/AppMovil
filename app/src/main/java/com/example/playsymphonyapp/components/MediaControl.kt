package com.example.playsymphonyapp.components // Este archivo contiene el diseño del reproductor de media de la biblioteca usando Jetpack Compose.
    ...
    )
    {
        Column(
            modifier = Modifier.align(Alignment.BottomStart)
                ...
                .background(color = Color.Gray)  // Fondo oscuro
...
fun MediaControlPreview() {
    MediaControl()  // Muestra el MediaControl en la vista previa
}